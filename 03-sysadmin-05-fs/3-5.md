...
Решение актуально для виртуальных дисков на которые грузятся крупные файлы по частям
## 2. Могут ли файлы, являющиеся жесткой ссылкой на один объект, иметь разные права доступа и владельца? Почему?
### Ответ:
Нет. Жесткие ссылки ссылаются на одну inode, в которой и содержится информация о правах и владельце.
...
--2022-08-09 03:08:06--  https://mirror.yandex.ru/ubuntu/ls-lR.gz
...
2022-08-09 03:08:06 (1.16 MB/s) - ‘/mnt/VG_0-lvol0/test.gz’ saved [22719572/22719572]
